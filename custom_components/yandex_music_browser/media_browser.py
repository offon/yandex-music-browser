...
def _enum_value(enum_cls, attr: str, default: str) -> str:
    value = getattr(enum_cls, attr, default)
    return getattr(value, "value", value)


MEDIA_CLASS_ALBUM = _enum_value(MediaClass, "ALBUM", "album")
MEDIA_CLASS_ARTIST = _enum_value(MediaClass, "ARTIST", "artist")
MEDIA_CLASS_DIRECTORY = _enum_value(MediaClass, "DIRECTORY", "directory")
MEDIA_CLASS_GENRE = _enum_value(MediaClass, "GENRE", "genre")
MEDIA_CLASS_PLAYLIST = _enum_value(MediaClass, "PLAYLIST", "playlist")
MEDIA_CLASS_TRACK = _enum_value(MediaClass, "TRACK", "track")

MEDIA_TYPE_ALBUM = _enum_value(MediaType, "ALBUM", "album")
MEDIA_TYPE_ARTIST = _enum_value(MediaType, "ARTIST", "artist")
MEDIA_TYPE_PLAYLIST = _enum_value(MediaType, "PLAYLIST", "playlist")
MEDIA_TYPE_TRACK = _enum_value(MediaType, "TRACK", "track")
